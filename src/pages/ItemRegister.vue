...
<template>
  <div class="text-center">
    ...
    <form @submit.prevent="submit()">
      ...
      <BaseInput v-model.lazy="username" label="Tittel" :error="errors.username"/>
      <BaseInput v-model.lazy="firstName" label="Beskrivelse" :error="errors.firstName"/>
      <BaseInput v-model.lazy="lastName" label="Pris" :error="errors.lastName" />

      <BaseInput v-model.lazy="email" label="Hovedkategori" :error="errors.email" />
      <BaseInput v-model="phoneNumber" label="Underkategori" :error="errors.phoneNumber"/>
      ...
      <BaseButton class="m-4" type="submit" :disabled="notValid">Send</BaseButton>
    </form>
  </div>
</template>
