...
<template>
	...
	<div
		...
		class="container mx-auto rounded-lg p-2 flex gap-2 bg-green-200 text-green-800"
	>
	...
	<div
		v-else
		class="container mx-auto rounded-lg p-2 flex gap-2 bg-slate-200 text-slate-600"
	>
