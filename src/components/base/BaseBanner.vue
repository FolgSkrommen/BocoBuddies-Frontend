...
<template>
	...
	<div
		...
		class="container mx-auto rounded-xl p-2 flex gap-2 bg-green-300 text-green-800"
	>
	...
	<div
		v-else
		class="container mx-auto rounded-xl p-2 flex gap-2 bg-slate-300 text-slate-800"
	>
